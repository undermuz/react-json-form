...
const ModeToggle: FC<ModeToggleProps> = ({ mode, onChange }) => {
    return (
        <div
            ...
            className="inline-flex rounded-full border border-rpb-border bg-rpb-elevated/80 p-1 backdrop-blur-md"
        >
                ...
                return (
                    <button
                        ...
                        className={[
                            ...
                            active
                                ? "bg-rpb-primary text-white shadow-[0_0_24px_rgb(95_160_78_/0.4)]"
