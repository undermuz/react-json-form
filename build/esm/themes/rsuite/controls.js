...
var ControlCheckBox = function (props) {
    ...
    var onChange = props.onChange, onBlur = props.onBlur;
    return (_jsx(Checkbox, __assign({ checked: Boolean(value), name: name, onChange: function (v, checked) { return onChange === null || onChange === void 0 ? void 0 : onChange(checked); }, onMouseLeave: function (e) {
...
var ControlTextBlock = function (props) {
    var name = props.name, value = props.value, _a = props.settings, settings = _a === void 0 ? {} : _a;
    var onChange = props.onChange, onBlur = props.onBlur;
    return (_jsx(Input, __assign({ as: "textarea", value: value, name: name }, settings, { onBlur: function (e) { return onBlur === null || onBlur === void 0 ? void 0 : onBlur(e.currentTarget.value); }, onChange: function (value) { return onChange === null || onChange === void 0 ? void 0 : onChange(value); } })));
};
var ControlInput = function (props) {
    var name = props.name, value = props.value, type = props.type;
    var onChange = props.onChange, onBlur = props.onBlur;
    return (_jsx(Input, { placeholder: name, name: name, type: type || "text", value: value, onChange: function (value) { return onChange === null || onChange === void 0 ? void 0 : onChange(value); }, onBlur: function (e) { return onBlur === null || onBlur === void 0 ? void 0 : onBlur(e.currentTarget.value); } }));
};
var Controls = {
    Input: ControlInput,
