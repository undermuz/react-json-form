...
var ControlCheckBox = function (props) {
    ...
    var onChange = props.onChange, onBlur = props.onBlur;
    return (_jsx(CheckBox, { checked: Boolean(value), name: name, label: title, onChange: function (event) { return onChange === null || onChange === void 0 ? void 0 : onChange(event.target.checked); }, onMouseLeave: function (e) { return onBlur === null || onBlur === void 0 ? void 0 : onBlur(e.currentTarget.checked); } }));
};
...
var ControlInput = function (props) {
    ...
    var onChange = props.onChange, onBlur = props.onBlur;
    return (_jsx(TextInput, { placeholder: name, name: name, type: type || "text", value: value, onChange: function (e) { return onChange === null || onChange === void 0 ? void 0 : onChange(e.currentTarget.value); }, onBlur: function (e) { return onBlur === null || onBlur === void 0 ? void 0 : onBlur(e.currentTarget.value); } }));
};
var Controls = {
    Input: ControlInput,
