...
var GeoSelect = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "geo-select-inline" },
        react_1.default.createElement("input", { placeholder: "\u0410\u0434\u0440\u0435\u0441", name: "address", type: "text", value: address, className: "form-control", onChange: handleChangeAddress, onBlur: handleTestAddress }),
        react_1.default.createElement("input", { name: "lat", type: "text", value: lat, className: "form-control", onChange: handleChangeLat, onBlur: handleTestLat }),
        react_1.default.createElement("input", { name: "lng", type: "text", value: lng, className: "form-control", onChange: handleChangeLng, onBlur: handleTestLng }),
        react_1.default.createElement(grommet_1.Button, { onClick: handleSelectOnMap }, "\u0412\u044B\u0431\u0440\u0430\u0442\u044C \u043D\u0430 \u043A\u0430\u0440\u0442\u0435")));
};
