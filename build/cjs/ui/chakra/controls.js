...
var ControlCheckBox = function (props) {
    ...
    var onChange = props.onChange, onBlur = props.onBlur;
    return ((0, jsx_runtime_1.jsx)(react_1.Checkbox, tslib_1.__assign({ checked: Boolean(value), name: name, onChange: function (event) { return onChange === null || onChange === void 0 ? void 0 : onChange(event.target.checked); }, onMouseLeave: function (e) {
...
var ControlTextBlock = function (props) {
    var name = props.name, value = props.value, _a = props.settings, settings = _a === void 0 ? {} : _a;
    var onChange = props.onChange, onBlur = props.onBlur;
    return ((0, jsx_runtime_1.jsx)(react_1.Textarea, tslib_1.__assign({ value: value, name: name }, settings, { onBlur: function (e) { return onBlur === null || onBlur === void 0 ? void 0 : onBlur(e.currentTarget.value); }, onChange: function (event) { return onChange === null || onChange === void 0 ? void 0 : onChange(event.currentTarget.value); } })));
};
var ControlInput = function (props) {
    var name = props.name, value = props.value, type = props.type;
    var onChange = props.onChange, onBlur = props.onBlur;
    return ((0, jsx_runtime_1.jsx)(react_1.Input, { placeholder: name, name: name, type: type || "text", value: value, onChange: function (e) { return onChange === null || onChange === void 0 ? void 0 : onChange(e.currentTarget.value); }, onBlur: function (e) { return onBlur === null || onBlur === void 0 ? void 0 : onBlur(e.currentTarget.value); } }));
};
var Controls = {
    Input: ControlInput,
